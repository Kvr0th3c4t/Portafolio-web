        ...
        <section className='px-50 py-15 w-full min-h-screen' id="contacto">
            ...
            <div className='grid grid-cols-3 gap-10'>
                ...
                <div className='col-span-2'>
                    ...
                    <p className="mb-10 text-neutral-400 font-['Syne'] text-lg">Le encanta el atún caro. Necesito empezar a trabajar en proyectos para financiar sus caprichos. Tú necesitas un desarrollador competente. Contacta conmigo. Hagamos un proyecto que beneficie a ambas partes (y a un gato muy exigente).</p>

                    <Button text="Contacto" href="mailto:adrianc.crim@hotmail.com"></Button>
                </div>
            </div>
